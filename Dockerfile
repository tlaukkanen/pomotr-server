...
RUN dotnet test --results-directory test-results /p:CollectCoverage=true /p:CoverletOutputFormat=cobertura /p:CoverletOutput=/test-results/coverage ./PomotrApp.Tests/PomotrApp.Tests.csproj
